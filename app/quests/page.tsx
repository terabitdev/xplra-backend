        ...
        <DashboardLayout>
            <div className="w-full p-6">
                ...
                <div className="flex justify-between items-center mb-6">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Quests Management</h1>
                        <p className="text-gray-600 mt-1">Create and manage your quests</p>
                    </div>
                    <button
                ...
                {loading ? (
                    <div className="flex flex-col items-center justify-center h-[60vh]">
                        ...
                        <p className="text-gray-600 mt-4 text-lg font-medium">Loading quests...</p>
                    </div>
                ) : error ? (
                    /* Error State */
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
                                    <tr>
                                        <th className="px-3 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-[200px]">Quest</th>
                                                ...
                                                <td className="px-3 py-3">
                                                    <div className="flex items-center gap-2 max-w-[200px]">
                                                        ...
                                                        <div className="min-w-0 flex-1">
                                                            ...
                                                            <p className="text-xs text-gray-500 mt-0.5 truncate">{quest.shortDescription}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="px-3 py-3 whitespace-nowrap">
                                                    <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                        {categories?.find((category: Category) => category.id === quest.category)?.name || 'N/A'}
                                                    </span>
                                                </td>
                                                <td className="px-3 py-3 whitespace-nowrap">
                                                    <div className="flex items-center gap-1">
                                                        ...
                                                        <span className="text-xs font-semibold text-gray-900">{quest.experience}</span>
                                                    </div>
                                                </td>
                                                <td className="px-3 py-3 whitespace-nowrap">
                                                    <div className="flex items-center gap-1 text-xs text-gray-700">
                                                        ...
                                                        <span className="font-medium">{quest.distance ? `${quest.distance}m` : '-'}</span>
                                                    </div>
                                                </td>
                                                <td className="px-3 py-3 whitespace-nowrap">
                                                    <div className="flex items-center gap-1 text-xs text-gray-700">
                                                        ...
                                                        <span className="font-medium">{quest.timeInSeconds ? `${Math.floor(quest.timeInSeconds / 60)}m` : '-'}</span>
                                                    </div>
                                                </td>
                                                <td className="px-3 py-3 whitespace-nowrap">
                                                    <div className="flex items-center gap-1 text-xs text-gray-700">
                                                        ...
                                                        <span className="font-medium">{quest.hoursToCompleteAgain ? `${quest.hoursToCompleteAgain}h` : '-'}</span>
                                                    </div>
                                                </td>
                                                <td className="px-3 py-3">
                                                    <div className="text-[10px] text-gray-600 space-y-0.5">
                                                        <div className="flex items-center gap-1">
                                                            ...
                                                            <span>{(quest.stepLatitude as number).toFixed(3)}</span>
                                                        </div>
                                                        <div className="flex items-center gap-1">
                                                            <span className="font-medium text-gray-500">Lng:</span>
                                                            <span>{(quest.stepLongitude as number).toFixed(3)}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="px-3 py-3 whitespace-nowrap">
