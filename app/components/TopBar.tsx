    ...
    <div className={`h-14 bg-white border-b border-gray-200 fixed top-0 left-0 right-0 z-[999] flex items-center justify-between px-3 lg:px-4 transition-all duration-300 ease-in-out ${
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        {isDropdownOpen && !loading && (
          <div className="absolute right-0 mt-1.5 w-52 bg-white border border-gray-200 rounded-lg shadow-lg py-1.5">
            ...
            <button
              ...
              className="w-full flex items-center gap-2.5 px-3 py-1.5 text-xs text-gray-700 hover:bg-gray-100 transition-colors"
            >
              <Edit size={16} />
              Edit Profile
            </button>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 outline-none"
              ...
              <div className="flex gap-2.5 pt-2">
                ...
                <button
                  ...
                  disabled={isSaving}
                  className="flex-1 px-3 py-2 text-sm bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-lg transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
