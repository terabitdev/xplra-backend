        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-4 scrollbar-hide" style={{
                ...
                {places.map((place) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {place.location && <p className="text-xs text-gray-500 truncate">{place.location}</p>}
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div>
            ...
            >
              ...
              <option value="codePhrase">Code Phrase</option>
            </select>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
              value={quest.xp || 0}
              onChange={(e) => setQuest({ ...quest, xp: parseInt(e.target.value) || 0 })}
              required
              disabled={loading}
            />
          </div>
          ...
          <div className="flex items-center">
            <input
              ...
              onChange={(e) => setQuest({ ...quest, isActive: e.target.checked })}
              disabled={loading}
            />
